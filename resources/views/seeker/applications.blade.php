            ...
            @foreach($applications as $application)
                ...
                <div class="card">
                    <div class="card-header bg-dark text-white">
                        <h3><span class="badge badge-light pull-right">Applied: {{ $application->created_at->diffForHumans() }}</span>
                        <strong>{{ $application->job->title }}</strong></h3>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-2">
                                <?php $img_src = '/storage/company_images/company'.$application->job->company_id.'.jpg'; ?>
                                ...
                                @endif
                                <h4 class="text-center pt-2"><strong>{{ $application->job->company->name }}</strong></h4>
                            </div>
                            <div class="col-md-10">
